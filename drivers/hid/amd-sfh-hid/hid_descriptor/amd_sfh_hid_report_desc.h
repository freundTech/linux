...
0X81, 0x00,		 /* HID Input (Data_Arr_Abs) */
0xC0,			 /* HID end collection */
0x0A, 0x44, 0x05,	 /* HID usage sensor data CUSTOM VALUE 1 */
0x15, 0x00,		 /* HID logical Min_16(0) */
0x26, 0x67, 0x01,	 /* HID logical Max_16(359) */
0x75, 16,		 /* HID report size(16) */
0x95, 1,		 /* HID report count (1) */
0X81, 0x02,		 /* HID Input (Data_Var_Abs) */
0x0A, 0x45, 0x05,	 /* HID usage sensor data CUSTOM VALUE 2 */
0x15, 0,		 /* HID logical Min_8(0) */
0x25, 1,		 /* HID logical Max_8(1) */
0x75, 8,		 /* HID report size(8) */
0x95, 1,		 /* HID report count (1) */
0X81, 0x02,		 /* HID Input (Data_Var_Abs) */
0x0A, 0x46, 0x05,	 /* HID usage sensor data CUSTOM VALUE 3 */
0x15, 0,		 /* HID logical Min_8(0) */
0x25, 7,		 /* HID logical Max_8(7) */
0x75, 8,		 /* HID report size(8) */
0x95, 1,		 /* HID report count (1) */
0X81, 0x02,		 /* HID Input (Data_Var_Abs) */
0xC0			 /* HID end collection */
